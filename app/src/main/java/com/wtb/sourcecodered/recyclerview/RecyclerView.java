    ...
    public static class RecycledViewPool {
        ...
        public ViewHolder getRecycledView(int viewType) {
            ...
            if (scrapData != null && !scrapData.mScrapHeap.isEmpty()) {
                final ArrayList<ViewHolder> scrapHeap = scrapData.mScrapHeap;
                Log.i("Layoutmanager.RecycledViewPool", "getRecycledView not null viewType=" + viewType + ",scrapHeap.size = " + scrapHeap.size());
                return scrapHeap.remove(scrapHeap.size() - 1);
            }
            Log.i("Layoutmanager.RecycledViewPool", "getRecycledView null ... viewType =" + viewType);
            return null;
        }
        ...
        public void putRecycledView(ViewHolder scrap) {
            ...
            Log.i("Layoutmanager.RecycledViewPool", "putRecycledView scrapHeap.size =" + scrapHeap.size() + ",scrap=" + scrap.toString());
            scrap.resetInternal();
            scrapHeap.add(scrap);
        }
