...
public class GreedoLayoutManager extends RecyclerView.LayoutManager {
    ...
    private int preFillGrid(Direction direction, int dy, int emptyTop,
        ...
        Log.i("Layoutmanager", "mFirstVisiblePosition = " + mFirstVisiblePosition);
        int currentRow = 0;
        ...
        while (nextPosition >= 0 && nextPosition < state.getItemCount()) {
            ...
            if (view == null) {
                Log.i("Layoutmanager", "viewCache.get null ,call getViewForPosition nextPosition = " + nextPosition);
...
//            if (isAtEndOfContent) {
//                Log.i("RecycledViewPool", "isAtEndOfContent nextPosition = " + nextPosition+",topOffset = "+topOffset+",getContentHeight() = "+getContentHeight());
//                break;
//            }
            ...
            nextPosition++;
            if (isAtEndOfContent) {
                Log.i("Layoutmanager", "isAtEndOfContent nextPosition = " + nextPosition+",topOffset = "+topOffset+",getContentHeight() = "+getContentHeight());
                break;
            }
        }
